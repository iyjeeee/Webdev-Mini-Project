    ...
    <div className="flex h-screen bg-gray-50 font-sans text-gray-900">
      ...
      <div className="w-64 bg-white flex flex-col h-full shrink-0">
        <div className="flex-1 overflow-y-auto">
          ...
          {/* Logo Area (With our top padding fix) */}
          ...
          <div className="px-4">
            ...
            <nav className="space-y-1.5">
              ...
              {/* Directory is removed here, just like you wanted */}
              <SidebarLink to="/attendance" icon={<Fingerprint size={20} />} label="My Attendance" />

              {/* --- iyje's Expandable Task Board (Styled to match your updates!) --- */}
              <div>
                <button
                ...
                >
                  ...
                  <span className="flex-1 text-left text-[14px]">My Task Board</span>
                  <ChevronDown size={16} className={`transition-transform duration-200 ${taskExpanded ? 'rotate-180' : ''}`} />
                </button>
