    ...
    <div className="space-y-1 w-full">
      ...
      <div className="relative flex items-center w-full">
        <DatePicker 
          ...
          className="w-full pl-3 pr-10 py-2 border border-gray-200 rounded-lg text-sm outline-none transition-colors focus:border-yellow-400 focus:ring-2 focus:ring-yellow-400 cursor-pointer"
        />
